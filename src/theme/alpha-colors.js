 ...
 * Generated: 2026-08-03T09:17:40.226Z
 */

/**
 * alpha-colors theme — built by `npx astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { alphaColorsTheme } from './alpha-colors';
 *   import './alpha-colors.css';
 */
export const alphaColorsTheme = {
  name: 'alpha-colors',
  __built: true,
  tokens: {
    ...
    "--font-family-body": "var(--font-alpha-body), Arial, sans-serif",
    "--font-family-heading": "var(--font-alpha-display), \"Arial Narrow\", Arial, sans-serif",
    ...
    "--color-accent": "light-dark(#1B4AED, #C9BEFF)",
    ...
    "--color-text-disabled": "light-dark(#928EA0, #5F5C6C)",
    ...
    "--color-icon-secondary": "light-dark(#312F3D, #C8C4D7)",
    "--color-icon-disabled": "light-dark(#928EA0, #5F5C6C)",
